...
previamente creada llamada DogResponses. Es como su fuera un arrayList de tipo <algo>

la palabra suspend esta puesta porque cuando llamo a esta funcion la tengo en un hilo diferente y es necesario
ponerlo, si no daría error, en la clase profesional.kt esta comentado el hilo.
 */
